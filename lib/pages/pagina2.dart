...
class Pagina2Page extends StatefulWidget {
  ...
  @override
  State<Pagina2Page> createState() => _Pagina2State();
}

class _Pagina2State extends State<Pagina2Page> {
  int posicaoArtigo = 0;
  ...
  void mostrarProximoArtigo() {
    if (posicaoArtigo < listaArtigos.length - 1) {
